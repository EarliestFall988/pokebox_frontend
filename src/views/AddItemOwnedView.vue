    ...
    <div class="hero min-h-screen bg-base-200">
        <div class="hero-content flex-col lg:flex-row-reverse">
            <div class="text-center lg:text-left">
                ...
                <p class="py-6">Add your newest Item to your box!</p>
            </div>
                ...
                <div>
                    <div class="card-body">
                        ...
                        <div class="form-control mt-6">
                            <button @click.prevent="attemptAddItemOwned"
...
<script setup>
    ...
    let attemptAddItemOwned = async () => {
        ...
        try {
            ...
            err.value = ""
            await fetch('https://localhost:7071/api/v1/Items/CreateItemsOwned?username=' +
                username.value +
                '&itemName=' +
                itemName.value,
                {
